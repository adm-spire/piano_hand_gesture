...
# Define drum colors
DRUM_COLORS = [(255, 0, 0), (0, 0, 255)]  # Red, Blue
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            for i, (drum_x, drum_y) in enumerate(drum_positions):
                ...
                if dist < drum_radius and ((i == 0 and hand_side == "Left") or (i == 1 and hand_side == "Right")):
                    # Assign xpos and ypos only when hand landmark is within drum region
                    xpos, ypos = index_finger_landmark.x, index_finger_landmark.y
